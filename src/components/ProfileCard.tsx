...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const resolvedGradient = customInnerGradient || innerGradient || DEFAULT_INNER_GRADIENT;
  const resolvedGlow = showBehindGlow && behindGlowEnabled;
  ...
  const cardStyle = useMemo(
    ...
    [iconUrl, grainUrl, resolvedGradient, behindGlowColor, behindGlowSize, cardRadius]
  );
  ...
  const shineStyle: React.CSSProperties = {
    maskImage: iconUrl ? 'var(--icon)' : 'none',
    maskRepeat: 'repeat',
    maskSize: '150%',
              ...
              {showUserInfo && (
                ...
                >
                  ...
                  <button
                    ...
                    style={{ pointerEvents: 'auto', borderRadius: '8px', background: 'transparent' }}
                    type="button"
